        ...
        for (let index = 0; index < num; index++) {
            ...
            <div class="mb-3">
                <div class="card-body bg-light shadow p-3 m-0 rounded-4">
                    <div class="d-flex flex-wrap justify-content-between align-items-center lder-glow">
                        <span class="lder bg-secondary col-5"></span>
                        <span class="lder bg-secondary col-3"></span>
                    </div>
                    <hr class="text-dark my-1">
                    <p class="card-text lder-glow">
                        <span class="lder bg-secondary col-6"></span>
                        <span class="lder bg-secondary col-5"></span>
                        <span class="lder bg-secondary col-12"></span>
                    </p>
                </div>
            </div>`;
        }
